...
SETTINGS_FILE="$S7ISOL/src/xournal/settings.xml"
TEMPLATE_FILE="$S7ISOL/src/xournal/template.typ"
COLOR_PALETTE_FILE="$S7ISOL/src/xournal/palette.gpl"

# ------------------------------------------------------------------------------

TOOLBAR_INI_FILE="$S7ISOL/src/xournal/toolbar.ini"
