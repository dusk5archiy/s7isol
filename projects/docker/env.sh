...
export CONFIG_PROJECT_NAME CONFIG_DOCKERFILE
...
if [[ -n ${WAYLAND_DISPLAY:-} ]]; then
  ...
  FROM_WAYLAND_SOCKET=$HostXdgRuntimeDir/$WAYLAND_DISPLAY
...
FROM_PIPEWIRE_SOCKET=$HostXdgRuntimeDir/pipewire-0
...
# Pulse ------------------------------------------------------------------------
#
FROM_PULSE_SOCKET=$HostXdgRuntimeDir/pulse
